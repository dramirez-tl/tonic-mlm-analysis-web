...
import { formatCurrencyWithCode, formatNumber, formatPercentage, GENERATION_COLORS, GENERATION_NAMES } from '@/lib/utils';
import { CurrencyProvider, useCurrency } from '@/context/currency-context';
import { ArrowLeft, Users, DollarSign, TrendingUp, Layers, BarChart3, User, Grid3X3, Scale, Network, Activity, Calculator, GitBranch } from 'lucide-react';
...
export default function DistributorPage() {
  ...
  const handlePeriodChange = (newPeriodId: string) => {
    router.push(`/distributor/${distributorId}?period=${newPeriodId}`);
  };
